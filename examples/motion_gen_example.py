...
def demo_motion_gen(js=False):
    ...
    motion_gen_config = MotionGenConfig.load_from_robot_config(
        ...
        interpolation_dt=0.01,
        # trajopt_dt=0.15,
        velocity_scale=0.5, #used to be command out 0.15
        use_cuda_graph=True,
    ...
    print(f"the input initial configuraton is: {start_state.position}")
    print(f"the input goal configuraton is: {goal_state.position}")
    ...
    # command out since when set the js=true, the new_result is undefined
